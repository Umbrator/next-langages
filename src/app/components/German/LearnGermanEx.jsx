...
const LearnGermanEx = () => {
  ...
  const determineLevel = (score) => {
    if (score >= 2) setLevel("A1");
    else if (score <= 5) setLevel("A2");
    else if (score <= 7) setLevel("B1");
    else if (score <= 8) setLevel("B2");
    else if (score <= 9) setLevel("C1");
    else setLevel("C2");
  };
  ...
  const exercises = [
      ...
      },
    {
      ...
      correctAnswer: "In der Tasse.",
      imageUrl: "https://deutschable.com/wp-content/uploads/2024/04/dog.jpg",
      niveau: "A2"
    },
    {
    ...
    {
      question: "Was ist drei plus drei??",
      options: [
        "Sieben",
        "Sechs",
        "Zwei"
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 py-10">
      ...
      {!showModal && (
        <div className="transition-all duration-700 transform card-container">
          {currentStep <= 10 && <Exercise step={currentStep} />}
          {currentStep > 10 && calculateFinalScore()}
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
          ...
          <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full text-center transform animate-flipIn">
            ...
            <p className="text-lg text-gray-700 mb-4">
              Du hast den Test abgeschlossen. Du hast <strong>{correctAnswers}</strong> von 10 Fragen richtig beantwortet.
            </p>
            <p className="text-lg text-gray-700 mb-4">
