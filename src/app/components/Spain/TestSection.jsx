      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="text-left flex flex-col justify-center">
          ...
          <p className="text-gray-600 max-w-md mb-8">
            Experience the transformative power of our courses through the voices of our students. See how we help them achieve fluency and confidence in Spanish.
          </p>
          <a
            href="#"
        ...
        <div className="grid grid-cols-1 gap-8">
          <div className="relative bg-[#1f1f1f] text-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex items-start">
              ...
              />
              <div>
                <div className="text-[#FF5733] mb-2 text-3xl">
                  <span>★★★★★</span>
                </div>
                ...
                <p className="text-gray-400 mt-2">
                  These courses have helped me gain confidence and fluency. The instructors are excellent, and the lessons are engaging.
                </p>
                <p className="mt-4 font-semibold">Carlos Martínez</p>
                <p className="text-gray-500">Business Spanish</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-[#1f1f1f] text-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-2">
                  The interactive lessons and the supportive community made learning Spanish enjoyable and effective.
                </p>
                <p className="mt-4 font-semibold">Maria Gomez</p>
                <p className="text-gray-500">Spanish for Kids</p>
              </div>
            </div>
          </div>
        </div>
