        ...
        {courseData.map((course, index) => (
          ...
          >
            ...
            <div className="w-full flex justify-start">
              <Link href={`/course/${course.title.toLowerCase().replace(/ /g, '-')}`}>
                <button className="bg-[#FF5733] text-white px-6 py-2 rounded-full inline-block text-center absolute -translate-y-1/2 z-10 transition-transform duration-300 hover:bg-[#D04B2C]">
                  ➤ LEARN MORE
                </button>
              </Link>
            </div>
