...
const Page = () => {
  // Namespace for German test localStorage keys
  const localStorageNamespace = "german_test";
  ...
  useEffect(() => {
    // Load data from localStorage specific to the German test
  ...
  useEffect(() => {
    // Save data to localStorage specific to the German test
    const dataToSave = {
      currentStep,
      scores,
      unlockedLevels,
    ...
    <div className="min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      <main className="pt-20 max-w-6xl mx-auto px-4 flex flex-col items-center">
        <div className="bg-white shadow-lg rounded-lg p-6 mb-6 w-full">
          <h1 className="text-4xl font-semibold mb-6 text-center text-[#FFCC00]">
