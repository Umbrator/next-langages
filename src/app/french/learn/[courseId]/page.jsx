  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta 
          name="description" 
          content={`Learn more about our ${course.title} course, including objectives, schedule, pricing, prerequisites, and FAQs. Perfect for anyone looking to master ${courseId}.`} 
        />
      </Head>
      ...
      <div className="container mx-auto p-8 lg:p-16 bg-white shadow-xl rounded-lg pt-20">
        ...
        {/* Course Header */}
        <div className="relative text-center mb-16 bg-gradient-to-r from-blue-700 to-blue-900 rounded-lg shadow-md p-6 lg:p-8 mt-0">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-10 rounded-lg shadow-lg mb-12">
          {course.levels.map((item, idx) => (
            <div key={idx} className="mb-8">
              <h3 className="text-xl font-semibold text-[#0056A8] mb-2">{item.level}</h3>
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-10 rounded-lg shadow-lg mb-12">
          <div className="flex items-center mb-4">
            <FaUserGraduate className="text-[#0056A8] text-2xl mr-2" />
            <h2 className="text-3xl font-bold text-[#0056A8]">Course Objectives</h2>
          </div>
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-10 rounded-lg shadow-lg mb-12">
          <div className="flex items-center mb-4">
            <FaCalendarAlt className="text-[#0056A8] text-2xl mr-2" />
            <h2 className="text-3xl font-bold text-[#0056A8]">Timetable and Pricing</h2>
          </div>
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#0056A8] text-white">
        ...
        {/* Prerequisites */}
        <div className="bg-gradient-to-br from-white to-gray-50 p-10 rounded-lg shadow-lg mb-12">
          <h2 className="text-3xl font-bold text-[#0056A8] mb-6">Prerequisites</h2>
          <p className="text-gray-700">{course.prerequisites}</p>
        </div>

        {/* FAQ Section */}
        <div className="bg-gradient-to-br from-white to-gray-50 p-10 rounded-lg shadow-lg mb-12">
          <h2 className="text-3xl font-bold text-[#0056A8] mb-6">Frequently Asked Questions (FAQ)</h2>
          <div className="space-y-8">
            {course.faq.map((faq, idx) => (
              <div key={idx}>
                <h3 className="text-xl font-semibold text-[#0056A8]">{faq.question}</h3>
