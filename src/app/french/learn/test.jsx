...
const LearnFrenchContent = () => {
  ...
  <div className="text-center mb-12">
    ...
    <p className="text-gray-600 mt-4">
      Explore our specialized French courses designed to help you reach fluency
  ...
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
    {[
      {
        imageSrc:
          "https://firebasestorage.googleapis.com/v0/b/oceangallery-d06ae.appspot.com/o/ocean_lagagues%2Fblonde-girl-painting.webp?alt=media&token=732e0ce1-c93e-4efb-9a2a-14cf44f875de",
      ...
      {
        imageSrc:
          "https://firebasestorage.googleapis.com/v0/b/oceangallery-d06ae.appspot.com/o/ocean_lagagues%2Fanswering-lesson.webp?alt=media&token=09023f9f-f7e9-41c9-b582-13b5b7727594",
      ...
      {
        imageSrc:
          "https://firebasestorage.googleapis.com/v0/b/oceangallery-d06ae.appspot.com/o/ocean_lagagues%2Flearn-french-language-online-education-concept%20(1).webp?alt=media&token=2627ec9e-1c21-48cd-939e-bc762ab36641",
      ...
      <div
        key={idx}
        className={`bg-white shadow-lg rounded-lg overflow-hidden border-l-4 ${card.borderColor} transform transition-transform duration-300 hover:scale-105`}
      >
        <img
  ...
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
    ...
    <div className="p-4">
      ...
      <p className="text-gray-600 mb-6">
        Dive into immersive French education with courses crafted to ensure
        effective and enjoyable language learning. Our flexible approach tailors
        each lesson to meet individual levels and goals.
      </p>
      <p className="text-gray-600 mb-6">
        From fundamental to advanced skills, our courses offer a comprehensive
        experience, helping you excel in French and broaden opportunities within
        French-speaking communities worldwide.
      </p>
      <button
        onClick={openModal}
        className="bg-[#EF4135] text-white px-6 py-3 rounded-full transition-transform duration-300 hover:scale-105 hover:bg-red-700"
      >
        ➤ LEARN MORE
      </button>
    </div>
...
>
  <div className="container mx-auto lg:flex lg:justify-between lg:items-center lg:space-x-8">
    ...
    <div className="lg:w-1/2">
      <img
        className="rounded-lg shadow-md object-cover w-full h-[400px] transition-transform duration-300 hover:scale-105"
        src="https://firebasestorage.googleapis.com/v0/b/oceangallery-d06ae.appspot.com/o/ocean_lagagues%2Fcharming-student-posing-classroom.webp?alt=media&token=4c6f4265-dd2e-46de-ab98-d5d71357153d"
    ...
    <div className="lg:w-1/2 bg-[#EF4135] text-white p-8 rounded-lg shadow-lg mt-8 lg:mt-0 border-l-8 border-[#0052A5]">
      ...
      <p className="mb-6">
        Discover our expert-led French courses designed to provide an immersive
        and customized learning experience. Our teaching methodology adapts to
        your individual proficiency level and learning style.
      </p>
      <p>
        Whether you’re a beginner or an advanced learner, our French language
        courses aim to help you achieve fluency and expand opportunities in
  ...
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
    {[
      ...
      <div
        key={index}
        className="bg-white p-6 rounded-lg shadow-md flex border-l-4 border-[#EF4135] hover:shadow-lg transition-shadow duration-300"
      >
