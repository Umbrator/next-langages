  ...
  return (
    <>
      <section className="py-16 bg-gradient-to-r from-[#0052A5] via-white to-[#EF4135]">
        {" "}
        {/* Gradient background matching the French flag */}
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-white shadow-lg rounded-lg overflow-hidden border-l-4 border-[#0052A5] transform hover:scale-105 transition-transform duration-300">
            {" "}
            {/* Blue border */}
            <img
          ...
          {/* Card 2 */}
          <div className="bg-white shadow-lg rounded-lg overflow-hidden border-l-4 border-[#EF4135] transform hover:scale-105 transition-transform duration-300">
            {" "}
            {/* Red border */}
            <img
              className="w-full h-48 object-cover"
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-semibold text-[#EF4135]">
                Group Class
              </h3>{" "}
              {/* Red text */}
              <p className="text-gray-600 mt-2">
                Join interactive group classes and practice French in a fun
                environment.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 mb-6">
              Experience high-quality French education with our tailored
      ...
      <section className="py-16 bg-gradient-to-r from-[#0052A5] via-white to-[#EF4135] " id="OurCourses">
        {" "}
        {/* Gradient inspired by the French flag */}
        <div className="container mx-auto text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            helping you achieve fluency and confidence in French.
          </p>
        </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  fluency in French. Our offerings include 1-on-1 lessons, group
                  classes, and practice sessions tailored to your needs.
                </p>
                <p className="text-gray-600 mb-6">
                  Whether you're a beginner or looking to refine your skills,
                  our expert teachers are here to guide you.
                </p>
                <button
                  onClick={closeModal}
        ...
        <div className="container mx-auto lg:flex lg:justify-between lg:items-center lg:space-x-8">
          ...
          <div className="lg:w-1/2 bg-[#EF4135] text-white p-8 rounded-lg shadow-lg mt-8 lg:mt-0 border-l-8 border-[#0052A5]">
            ...
            <h2 className="text-4xl font-bold mb-4">
              Why Choose Inlingo French Courses?
            </h2>
            <p className="mb-6">
              Discover the excellence of our French courses, designed to provide
              you with a tailored learning experience. Our methodology adapts to
              your individual level and learning preferences.
            </p>
            <p>
              From beginners to advanced learners, we offer a comprehensive
              educational approach to help you achieve your language goals and
              flourish in French-speaking environments.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <div className="bg-white p-6 rounded-lg shadow-md flex border-l-4 border-[#EF4135]">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Our certified and native-speaking teachers provide immersive and
                effective French lessons tailored to your needs.
              </p>
            </div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md flex border-l-4 border-[#EF4135]">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Engage with interactive materials for a dynamic and practical
                learning experience.
              </p>
            </div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md flex border-l-4 border-[#EF4135]">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Tailored courses that match the specific progress and needs of
                each student.
              </p>
            </div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md flex border-l-4 border-[#EF4135]">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Earn globally recognized certificates to advance your career
                opportunities.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="text-left flex flex-col justify-center">
            ...
            <p className="text-gray-600 max-w-md mb-8">
              Discover the impact of our courses through our students’
              experiences. See how they achieved fluency and confidence in
              French with our help.
            </p>
            <a
              href="#"
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mt-2">
                    These courses have greatly improved my French skills. The
                    instructors are top-notch, and the classes are interactive
                    and engaging.
                  </p>
            ...
            <div className="relative bg-[#1f1f1f] text-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mt-2">
                    I enjoyed every lesson. The practical exercises and friendly
                    environment made learning French so much easier.
                  </p>
