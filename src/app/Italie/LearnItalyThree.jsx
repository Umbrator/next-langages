      ...
      <div className="container mx-auto lg:flex lg:justify-between lg:items-center lg:space-x-8">
        ...
        <div className="lg:w-1/2">
          <img
            ...
            style={{ width: "100%", height: "400px", objectFit: "cover" }} // Ensures the image takes full width while maintaining the aspect ratio
          />
        </div>

        {/* Text on the right */}
        <div className="lg:w-1/2 bg-[#004400] text-white p-8 rounded-lg shadow-lg mt-8 lg:mt-0">
          <h3 className="text-sm font-semibold mb-2 text-[#FF4C4C]">
            ➤ WHY US
          </h3>
          <h2 className="text-4xl font-bold mb-4">
            Why Inlingo Italian Courses?
          </h2>
          <p className="mb-6">
            Nos cours d'italien sont conçus pour vous offrir une expérience
            d'apprentissage immersive et complète. Que vous soyez débutant ou
            apprenant avancé, nos cours sont adaptés à vos besoins pour vous
            aider à atteindre la fluidité.
          </p>
          <p>
            Avec des leçons interactives, une attention personnalisée et des
            certifications reconnues mondialement, nous nous assurons que nos
            étudiants apprennent non seulement la langue mais aussi la culture
            italienne.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        ...
        <div className="bg-[#E6E6E6] p-6 rounded-lg shadow-md flex">
          <div className="flex-shrink-0 mr-4">
            <svg
              className="w-12 h-12 text-[#004400]"
              fill="currentColor"
          ...
          <div>
            ...
            <p className="text-gray-800 mt-2">
              Notre équipe d'enseignants natifs garantit une expérience
              d'apprentissage authentique et immersive.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#E6E6E6] p-6 rounded-lg shadow-md flex">
          ...
          <div>
            ...
            <p className="text-gray-800 mt-2">
              Participez à des leçons qui incluent des contextes culturels réels
              pour une expérience pratique et immersive.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#E6E6E6] p-6 rounded-lg shadow-md flex">
          ...
          <div>
            ...
            <p className="text-gray-800 mt-2">
              Des cours conçus pour s'adapter aux besoins et objectifs
              individuels de chaque étudiant, assurant un apprentissage
              efficace.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#E6E6E6] p-6 rounded-lg shadow-md flex">
          ...
          <div>
            ...
            <p className="text-gray-800 mt-2">
              Obtenez des certifications reconnues mondialement pour améliorer
              vos qualifications en langue italienne.
            </p>
          </div>
        </div>
      </div>
