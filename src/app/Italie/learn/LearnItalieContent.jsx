    ...
    <>
      ...
      <section className="py-16 bg-gradient-to-b bg-gray-100">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 mt-4 max-w-2xl mx-auto">
            ...
            fluency in Italian with a structured and enjoyable approach.
          </p>
        </div>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              We are Dedicated to the Best of Italian Courses
            </h2>
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            <button
              className="absolute top-3 right-3 text-gray-600 hover:text-green-600 transition-colors" // Green on hover for Italian theme
              onClick={closeModal}
            ...
            {isLoading ? (
              <div className="text-center">
                <div className="animate-spin text-5xl text-green-500 mb-4">
                  ⏳
                </div>{" "}
                {/* Green spinner */}
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  fluency in Italian. Our formations include 1-on-1 lessons,
                ...
                <button
                  onClick={closeModal}
                  className="bg-gradient-to-r from-green-500 to-red-500 text-white py-2 px-4 rounded hover:bg-red-700 transition-transform duration-300 mt-6" // Green to red gradient for Italian theme
                >
                  Close
                </button>
              </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto lg:flex lg:justify-between lg:items-center lg:space-x-8">
          ...
          {/* Text on the right with Italian-themed gradient */}
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md flex">
            <div className="flex-shrink-0 mr-4">
              <svg
                className="w-12 h-12 text-green-700" // Green accent for Italian theme
                fill="currentColor"
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md flex">
            <div className="flex-shrink-0 mr-4">
              <svg
                className="w-12 h-12 text-red-700" // Red accent for Italian theme
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
              ...
              <div className="flex items-start">
                ...
                <div>
                  <div className="text-green-500 mb-2 text-3xl">
                    {" "}
                    {/* Green stars for Italian theme */}
                    <span>★★★★★</span>
                  </div>
                  <h3 className="text-2xl font-semibold">
                    Best Italian Courses Ever!
                  </h3>
