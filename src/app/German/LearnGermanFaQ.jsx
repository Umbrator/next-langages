  ...
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
    ...
    <div className="relative flex items-center">
      ...
      <div className="absolute bottom-0 right-0 flex space-x-1 space-y-1">
        <div className="w-4 h-4 bg-yellow-500"></div> {/* Yellow square for German color accent */}
        <div className="w-4 h-4 bg-red-600"></div> {/* Red square for German color accent */}
      </div>
    </div>

    {/* FAQ Section */}
    <div className="text-left flex flex-col justify-center">
      <h3 className="text-sm font-semibold text-red-600 mb-2 flex items-center"> {/* Red for "FAQ" */}
        <FaAngleDoubleRight className="ml-2 text-yellow-500" /> {/* Yellow icon for German accent */}
        FAQ
      </h3>
      <h2 className="text-4xl font-bold text-gray-900 mb-4"> {/* Darker gray for the main heading */}
