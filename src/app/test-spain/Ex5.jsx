...
const Ex5 = ({
  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-lg max-w-3xl mx-auto mt-16">
      <h2 className="text-4xl font-bold text-center text-[#C60B1E] mb-6">
      ...
      {showCompletionModal ? (
        <div className="text-center mt-8">
          <p className="text-2xl font-bold text-[#FFC300] mb-2">
            🎉 Congratulations! 🎉
          </p>
          <p className="text-gray-600 mb-4">
            You have successfully completed level C1.
          </p>
          <p className="text-lg font-semibold text-[#FFC300] mb-4">
            Your language proficiency test is complete!
          </p>
          <button
            onClick={handleConfirm}
            className="bg-[#FFC300] text-white py-3 px-8 rounded-full shadow-md hover:shadow-lg hover:bg-[#FFB300] mt-4 transition-transform duration-300"
          >
            Finish Test
          </button>
        </div>
        ...
        <div className="text-center mt-8 p-6 bg-white rounded-lg shadow-lg">
          <h3 className="text-2xl font-bold text-[#C60B1E] mb-4">Level Not Reached</h3>
          ...
          <div className="flex justify-center space-x-4">
            <button
              ...
              className="bg-[#FFC300] text-white flex items-center py-2 px-4 rounded-full shadow-md hover:bg-[#FFB300] transition-all duration-300"
            >
              <FaWhatsapp className="mr-2" size={18} /> Share on WhatsApp
            </button>
            <button
              onClick={() => (window.location.href = "tel:+212704309787")}
              className="bg-[#C60B1E] text-white flex items-center py-2 px-4 rounded-full shadow-md hover:bg-[#B50A1C] transition-all duration-300"
            >
        ...
        <>
                ...
                <button
                  ...
                  className={`border-2 p-3 rounded-lg mb-4 block w-full text-left transition-all duration-300 ${
                    selectedOptionIndex === idx
                      ? option.correct
                        ? "bg-[#FFECB3] border-[#FFC300]"
                        : "bg-[#FFCDD2] border-[#C60B1E]"
          ...
          <button
            ...
            className="bg-[#C60B1E] text-white py-3 px-8 rounded-full shadow-md hover:shadow-lg hover:bg-[#B50A1C] transition-transform duration-300 focus:outline-none flex items-center justify-center space-x-2"
          >
